...
## [v2.6.1](https://github.com/route06/actions/compare/v2.6.0...v2.6.1) - 2025-07-03
...
- build(deps): bump Songmu/tagpr from 1.5.2 to 1.7.0 by @dependabot in https://github.com/route06/actions/pull/108
- build(deps): bump ls-lint/action from 2.3.0 to 2.3.1 by @dependabot in https://github.com/route06/actions/pull/107
- build(deps-dev): bump tar-fs from 2.1.2 to 2.1.3 by @dependabot in https://github.com/route06/actions/pull/106
